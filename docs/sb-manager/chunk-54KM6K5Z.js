      ...
      var _self =
        ...
        Prism = (function (_self2) {
          ...
          if (!_.manual) {
            ...
            readyState === "isLoading" || (readyState === "interactive" && script && script.defer)
...
var ActionBar = ({ actionItems, ...props }) =>
  ...
  GlobalScrollAreaStyles = (0, import_react.lazy)(() => import("./GlobalScrollAreaStyles-XIHNDKUY-F4JIPIHL.js")),
  OverlayScrollbars = (0, import_react.lazy)(() => import("./OverlayScrollbars-VAV6LJAB-K3TMPSMY.js")),
  ...
  ScrollArea = emotion_styled_browser_esm_default(Scroller)(
    ...
    ({ horizontal }) => (horizontal ? { overflowX: "auto", width: "100%" } : { overflowX: "hidden" })
  );
...
var Wrapper = emotion_styled_browser_esm_default.div(
  ...
  Scroller2 = emotion_styled_browser_esm_default(UnstyledScroller)({ position: "relative" }, ({ theme }) =>
    themedSyntax(theme)
  ),
